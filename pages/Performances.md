...
{% include feature/card.html header="August Mawnin" text="The card features an image from the collection as a cap" objectid="coll053" width="25" float="left" %} {% include feature/card.html header="ZuZuWah" text="The card features an image from the collection as a cap" objectid="coll053" width="25" centered=true %} {% include feature/card.html header="Olde Tyme Country Wedding" text="The card features an image from the collection as a cap" objectid="coll053" width="25" float="right" %}
